    ...
    return (
        <>
            <section id="billboard" className="position-relative overflow-hidden bg-light-blue">
                ...
                <div className="swiper-icon swiper-arrow swiper-arrow-prev" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-8e966e618222e9d4" aria-disabled="false"></div>
                <div className="swiper-icon swiper-arrow swiper-arrow-next" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-8e966e618222e9d4" aria-disabled="true"></div>
            </section>
        </>
    );
  }
