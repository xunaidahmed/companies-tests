...
import Slider from "./child-components/slider";
import Product from "./child-components/product";
          ...
          <div className="container">
              ...
              <div className="col-md-5 col-sm-12" style={{ margin: "0 auto"}}>
                  <form className="subscription-form validate">
                      ...
                      <input className="form-control btn-rounded-none" type="email" name="EMAIL" placeholder="Your email address here" />
