                ...
                <div className="footer-top-area">
                    ...
                    <div className="col-lg-2 col-sm-6 pb-3">
                        ...
                        <ul className="menu-list list-unstyled text-uppercase">
                            ...
                            <li className="menu-item pb-2"><Link href="/about">About</Link></li>
                            <li className="menu-item pb-2"><a href="/product">Products</a></li>
                            <li className="menu-item pb-2"><a href="#">Blogs</a></li>
                            <li className="menu-item pb-2"><Link href="/contact">Contact</Link></li>
                        </ul>
                        </div>
                    </div>
                    <div className="col-lg-3 col-sm-6 pb-3">
                        ...
                        <ul className="menu-list list-unstyled">
                            ...
                            <li className="menu-item pb-2"><a href="/contact">Contact Us</a></li>
