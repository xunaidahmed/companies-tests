        ...
        <header id="header" className="site-header header-scrolled position-fixed text-black bg-light">
            <nav id="header-nav" className="navbar navbar-expand-lg px-3 mb-3">
                <div className="container-fluid">
                    ...
                    <div className="offcanvas offcanvas-end" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                        ...
                        <div className="offcanvas-body">
                            <ul id="navbar" className="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                                ...
                                <li className="nav-item"><Link href="/product" className="nav-link me-4">Products</Link></li>
                                <li className="nav-item"><Link href="/contact" className="nav-link me-4">Contact</Link></li>
